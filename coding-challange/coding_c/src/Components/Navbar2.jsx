...
const Navbar = () => {
    ...
    return (
        ...
        <div style={{ width: "100%", backgroundColor: "rgb(63,81,181)", display: "flex", justifyContent: "space-between" }}>

            <div style={{ display: "flex" }}>
                <div style={{ paddingTop: "12px", paddingLeft: "10px" }}><svg className="change-my-color" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48"><path d="M22 18h-4V4h-4v14h-4V4H6v14c0 4.25 3.32 7.69 7.5 7.95V44h5V25.95c4.18-.26 7.5-3.7 7.5-7.95V4h-4v14zm10-6v16h5v16h5V4c-5.52 0-10 4.48-10 8z" /></svg></div>
